...
if(!-[1,]){
	...
	div.innerHTML = '<br /><br /><br /><br /><img src="http://browser-update.org/img/big/ch.png" alt="chrome" /><img src="http://browser-update.org/img/big/ff.png" alt="firefox" /><span style="color:#fff;background:#3300CC;font-size:1.7rem;">你的浏览时是IE? 升级你的浏览器, bulabulabula~~</span>'; 
    document.body.insertBefore(div, document.body.firstElementChild);
}

//打印东东
console.log(
	'%c 你在偷看我的元素吗 %c 请用先进的浏览器浏览我 %c 球球：82594006',
	'background:#36465d;color:#fff;',
	'background:#CCCC33;color:#9933CC;',
	'background:#772953;color:#fff;',
	); 
